...
namespace rtype::game {
    ...
    class SMenu : public GameState {
        ...
        public: //data declared here are suggested to behave differently in the next patch due to ECS updates
            std::vector<rtype::components::Button> btns;
        ...
        public:
            ...
            void init() override {
                ...
                btns.push_back(components::Button(sf::Color::Green, "PLAY", pos, {200,60}));
                btns.push_back(components::Button(sf::Color::Red, "QUIT", {pos.x, pos.y + 120}, {200,60}));
            ...
            /**
             * @brief Draw all the button in the menu
             *
             * @param w the window where you want to draw buttons
             */
